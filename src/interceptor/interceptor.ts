...
const errorMessages = {
  en: "Please start by saying 'hyper', then say what you want to do, by how many centimeters, and in which direction with either forward or backward. For example: 'hyper move seat 8 centimeters forward'.",
...
const getErrorMessage = async (text) => {
