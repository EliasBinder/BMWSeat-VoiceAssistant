  ...
  stopTranscription = async () => {
    ...
    try {
      resp = await openAI.audio.transcriptions.create({
        ...
        prompt: "Please transcribe the following audio with high accuracy. Pay special attention to unique structures that may appear, such as 'hyper sitz bewegen 1 zentimeter vorwärts' or its English equivalent 'hyper seat move 1 centimeter forward.' Ensure these phrases are transcribed exactly as spoken."
      });
